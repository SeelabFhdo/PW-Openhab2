...
/**
 * The {@link SamsungTvHandlerFactory} is responsible for creating things and thing 
 * handlers.
 * 
...
public class SamsungTvHandlerFactory extends BaseThingHandlerFactory {
    ...
    private final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(SAMSUNG_TV);
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(SAMSUNG_TV)) {
            return new SamsungTvHandler(thing);
        }
